...
// Notification start
    ...
    $('.notiClick').click(function () {
        ...
        $('.notification').css('right', '50px')
        setTimeout(() => {
        $('.notification').css('right', '-999px')
        },3000)
    })
    ...
    $(window).scroll(function () {
        ...
        // console.log(scroll);
                ...
                if ( scroll >= 30) {
                    ...
                    navbar1.addClass('navbar-navbar1');

                } else {
                    navbar.removeClass('navbar-sticky');
                    navbar1.removeClass('navbar-navbar1');
                }
 
    })

    let img = ['france.png','spain.png','britain.png','haiti.png'];
    let img_show = document.querySelector(".img_show");
    let text_show = document.querySelector(".text_show");
    let video_show = document.querySelector(".video_show");
    let click_video_show = document.querySelector(".click_video_show");
    video_show.style.display ='none'
    click_video_show.style.display ='flex'
    $('.my_click').click(() => {
        $('.click_area').addClass("add_click")
    });

    $('.remove_flag_section').click(() => {
        $('.click_area').removeClass("add_click")
    });
   

    $('.click_one').click(() => {
        img_show.src = img[0];
        text_show.innerText = "FR"
    });
    $('.click_tow').click(() => {
        img_show.src = img[1];
        text_show.innerText = "SP"
    });
    $('.click_three').click(() => {
        img_show.src = img[2];
        text_show.innerText = "EN"
    });
    $('.click_four').click(() => {
        img_show.src = img[3];
        text_show.innerText = "HA"
    });
    $('.click_video_show').click(() => {
         click_video_show.style.display ='none'
